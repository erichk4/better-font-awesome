<?php
    ...
    class Better_Font_Awesome_Plugin
    {
         ...
         *
         * @return  Better_Font_Awesome_Plugin  The BFA object.
         */
        ...
        public function create_admin_page()
        {
            ...
            <div class="wrap bfa-settings">
                ...
                <form method="post" action="options.php" id="bfa-settings-form">
                    ...
                    ?>
                    <p>
                        <span class="button-primary bfa-save-settings-button"><?php esc_html_e( 'Save Settings', 'better-font-awesome' ); ?></span>
                        <img class="bfa-loading-gif"
                             src="<?php echo esc_attr( includes_url() . 'images/spinner.gif' ); ?>"/>
                    </p>
            ...
            if ( 'settings_page_better-font-awesome' === $hook )
            {
                ...
                wp_localize_script(
                    ...
                    array(
                        ...
                        'nonce'    => wp_create_nonce( 'better-font-awesome-ajax-nonce' )
                    )
                );
            }
        }
        ...
        {
            if ( !wp_verify_nonce( $_POST[ 'nonce' ], 'better-font-awesome-ajax-nonce' ) )
            {
                wp_die ( 'Busted!' );
            }
